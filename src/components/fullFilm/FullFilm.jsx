      ...
      return (
        <div className="fullfilm">
          ...
          <div className="fullfilm__sunmaininfo">
            <div className="fullfilm__genres">
              Жанр:
              {this.state.genres || this.smile}
            </div>
            <div className="fullfilm__actors">
              Актеры:
              {this.state.actors || this.smile}
            </div>
            <div className="fullfilm__composers">
              Композиторы:
              {this.state.composers || this.smile}
            </div>
          </div>
          <div className="fullfilm__description">
            Описание:
            {this.state.description || this.smile}
          </div>
